...
object PackUpdateScheduler {
    ...
    fun sync(context: Context, enabled: Boolean, allowMetered: Boolean) {
        ...
        val job = JobInfo.Builder(PERIODIC_JOB_ID, ComponentName(context, PackUpdateJobService::class.java))
            .setRequiredNetworkType(if (allowMetered) JobInfo.NETWORK_TYPE_ANY else JobInfo.NETWORK_TYPE_UNMETERED)
